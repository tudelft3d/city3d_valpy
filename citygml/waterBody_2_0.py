# ./citygml/waterBody_2_0.py
# -*- coding: utf-8 -*-
# PyXB bindings for NM:758469a710dce3cc50e7f9e1eab0d3820acb06f3
# Generated 2016-02-09 15:38:06.028680 by PyXB version 1.2.4 using Python 2.7.10.final.0
...
class BoundedByWaterSurfacePropertyType (pyxb.binding.basis.complexTypeDefinition):
    ...
    __type = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(_Namespace_xlink, 'type'), 'type', '__httpwww_opengis_netcitygmlwaterbody2_0_BoundedByWaterSurfacePropertyType_httpwww_w3_org1999xlinktype', _ImportedBinding_citygml__xlink.typeType, fixed=True, unicode_default='simple')
    ...
    __href = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(_Namespace_xlink, 'href'), 'href', '__httpwww_opengis_netcitygmlwaterbody2_0_BoundedByWaterSurfacePropertyType_httpwww_w3_org1999xlinkhref', _ImportedBinding_citygml__xlink.hrefType)
    ...
    __role = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(_Namespace_xlink, 'role'), 'role', '__httpwww_opengis_netcitygmlwaterbody2_0_BoundedByWaterSurfacePropertyType_httpwww_w3_org1999xlinkrole', _ImportedBinding_citygml__xlink.roleType)
    ...
    __arcrole = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(_Namespace_xlink, 'arcrole'), 'arcrole', '__httpwww_opengis_netcitygmlwaterbody2_0_BoundedByWaterSurfacePropertyType_httpwww_w3_org1999xlinkarcrole', _ImportedBinding_citygml__xlink.arcroleType)
    ...
    __title = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(_Namespace_xlink, 'title'), 'title', '__httpwww_opengis_netcitygmlwaterbody2_0_BoundedByWaterSurfacePropertyType_httpwww_w3_org1999xlinktitle', _ImportedBinding_citygml__xlink.titleAttrType)
    ...
    __show = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(_Namespace_xlink, 'show'), 'show', '__httpwww_opengis_netcitygmlwaterbody2_0_BoundedByWaterSurfacePropertyType_httpwww_w3_org1999xlinkshow', _ImportedBinding_citygml__xlink.showType)
    ...
    __actuate = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(_Namespace_xlink, 'actuate'), 'actuate', '__httpwww_opengis_netcitygmlwaterbody2_0_BoundedByWaterSurfacePropertyType_httpwww_w3_org1999xlinkactuate', _ImportedBinding_citygml__xlink.actuateType)
...
class AbstractWaterObjectType (_ImportedBinding_citygml_cgmlbase_2_0.AbstractCityObjectType):
...
class AbstractWaterBoundarySurfaceType (_ImportedBinding_citygml_cgmlbase_2_0.AbstractCityObjectType):
...
AbstractWaterBoundarySurfaceType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'lod2Surface'), _ImportedBinding_citygml__gml.SurfacePropertyType, scope=AbstractWaterBoundarySurfaceType, location=pyxb.utils.utility.Location('/Users/octeufer/Work/workspace/virenvwspace/virtual_valcity3d/val3dpy/CGML2_0/CityGML/waterBody.xsd', 92, 5)))

AbstractWaterBoundarySurfaceType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'lod3Surface'), _ImportedBinding_citygml__gml.SurfacePropertyType, scope=AbstractWaterBoundarySurfaceType, location=pyxb.utils.utility.Location('/Users/octeufer/Work/workspace/virenvwspace/virtual_valcity3d/val3dpy/CGML2_0/CityGML/waterBody.xsd', 93, 5)))

AbstractWaterBoundarySurfaceType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'lod4Surface'), _ImportedBinding_citygml__gml.SurfacePropertyType, scope=AbstractWaterBoundarySurfaceType, location=pyxb.utils.utility.Location('/Users/octeufer/Work/workspace/virenvwspace/virtual_valcity3d/val3dpy/CGML2_0/CityGML/waterBody.xsd', 94, 5)))
...
WaterBodyType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'class'), _ImportedBinding_citygml__gml.CodeType, scope=WaterBodyType, location=pyxb.utils.utility.Location('/Users/octeufer/Work/workspace/virenvwspace/virtual_valcity3d/val3dpy/CGML2_0/CityGML/waterBody.xsd', 50, 5)))

WaterBodyType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'function'), _ImportedBinding_citygml__gml.CodeType, scope=WaterBodyType, location=pyxb.utils.utility.Location('/Users/octeufer/Work/workspace/virenvwspace/virtual_valcity3d/val3dpy/CGML2_0/CityGML/waterBody.xsd', 51, 5)))

WaterBodyType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'usage'), _ImportedBinding_citygml__gml.CodeType, scope=WaterBodyType, location=pyxb.utils.utility.Location('/Users/octeufer/Work/workspace/virenvwspace/virtual_valcity3d/val3dpy/CGML2_0/CityGML/waterBody.xsd', 52, 5)))

WaterBodyType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'lod0MultiCurve'), _ImportedBinding_citygml__gml.MultiCurvePropertyType, scope=WaterBodyType, location=pyxb.utils.utility.Location('/Users/octeufer/Work/workspace/virenvwspace/virtual_valcity3d/val3dpy/CGML2_0/CityGML/waterBody.xsd', 53, 5)))

WaterBodyType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'lod0MultiSurface'), _ImportedBinding_citygml__gml.MultiSurfacePropertyType, scope=WaterBodyType, location=pyxb.utils.utility.Location('/Users/octeufer/Work/workspace/virenvwspace/virtual_valcity3d/val3dpy/CGML2_0/CityGML/waterBody.xsd', 54, 5)))

WaterBodyType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'lod1MultiCurve'), _ImportedBinding_citygml__gml.MultiCurvePropertyType, scope=WaterBodyType, location=pyxb.utils.utility.Location('/Users/octeufer/Work/workspace/virenvwspace/virtual_valcity3d/val3dpy/CGML2_0/CityGML/waterBody.xsd', 55, 5)))

WaterBodyType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'lod1MultiSurface'), _ImportedBinding_citygml__gml.MultiSurfacePropertyType, scope=WaterBodyType, location=pyxb.utils.utility.Location('/Users/octeufer/Work/workspace/virenvwspace/virtual_valcity3d/val3dpy/CGML2_0/CityGML/waterBody.xsd', 56, 5)))

WaterBodyType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'lod1Solid'), _ImportedBinding_citygml__gml.SolidPropertyType, scope=WaterBodyType, location=pyxb.utils.utility.Location('/Users/octeufer/Work/workspace/virenvwspace/virtual_valcity3d/val3dpy/CGML2_0/CityGML/waterBody.xsd', 57, 5)))
...
WaterBodyType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'lod3Solid'), _ImportedBinding_citygml__gml.SolidPropertyType, scope=WaterBodyType, location=pyxb.utils.utility.Location('/Users/octeufer/Work/workspace/virenvwspace/virtual_valcity3d/val3dpy/CGML2_0/CityGML/waterBody.xsd', 59, 5)))

WaterBodyType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'lod4Solid'), _ImportedBinding_citygml__gml.SolidPropertyType, scope=WaterBodyType, location=pyxb.utils.utility.Location('/Users/octeufer/Work/workspace/virenvwspace/virtual_valcity3d/val3dpy/CGML2_0/CityGML/waterBody.xsd', 60, 5)))
...
WaterSurfaceType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'waterLevel'), _ImportedBinding_citygml__gml.CodeType, scope=WaterSurfaceType, documentation='Type for the specification of the level of a water surface. The optional attribute waterLevel of a\n\t\t\t\t\t\t\t\tWaterSurface can be used to describe the water level, for which the given 3D surface geometry was acquired. This\n\t\t\t\t\t\t\t\tis especially important, when the water body is influenced by the tide. The values of this type are defined in\n\t\t\t\t\t\t\t\texternal code lists.', location=pyxb.utils.utility.Location('/Users/octeufer/Work/workspace/virenvwspace/virtual_valcity3d/val3dpy/CGML2_0/CityGML/waterBody.xsd', 115, 5)))
...
WaterObject._setSubstitutionGroup(_ImportedBinding_citygml_cgmlbase_2_0.CityObject)

WaterBoundarySurface._setSubstitutionGroup(_ImportedBinding_citygml_cgmlbase_2_0.CityObject)
